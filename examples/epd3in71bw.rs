...
use epd_gooddisplay::{
    color::*,
    epd3in71bw::{Display3in71, EPD3in71bw},
...
fn main() -> Result<(), std::io::Error> {
    ...
    let mut epd3in71bw =
        EPD3in71bw::new(&mut spi, cs, busy, dc, rst, &mut delay).expect("eink initalize error");
    ...
    epd3in71bw.update_frame(&mut spi, &display.buffer())?;
    epd3in71bw
    ...
    epd3in71bw
        ...
        .unwrap();
    epd3in71bw.clear_frame(&mut spi).unwrap();
    for i in 0..limit {
    ...
    epd3in71bw.sleep(&mut spi)
}

fn draw_text(display: &mut Display3in71, text: &str, x: i32, y: i32) {
